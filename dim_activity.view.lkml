...
#           ;;
  ...
  dimension: activity_app_type {
    ...
    sql: CASE WHEN ${TABLE}.APPLICATIONNAME  IN ('ADAPTIVE','APLIA','APLIAMOBILE','CNOW.HW','SAM.APPIFICATION.PROD','WEBASSIGN','CENGAGE.ASSIGNMENT','CENGAGE.MINDTAPCASACTIVITYPLAYER','CEREGO','MINDAPP-GROVE')
            OR ${TABLE}.APPLICATIONNAME ilike 'DLMT%'
          THEN 'Assessment'
           WHEN ${TABLE}.APPLICATIONNAME  IN ('CENGAGE.FLASHCARD','CENGAGE.READER','CENGAGE.READER.MT4','CENGAGE.RSSFEED','FLASHNOTES','CENGAGE.RSSFEED','LAMS','LAMS_V2','CENGAGE.QUESTIA')
          THEN 'Narrative'
